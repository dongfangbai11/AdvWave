...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=10, zero_init_residual=False,
        ...
        # This improves the a-model by 0.2~0.3% according to https://arxiv.org/abs/1706.02677
...
def resnet18(pretrained=False, progress=True, device='cpu', **kwargs):
    """Constructs a ResNet-18 a-model.

    Args:
        pretrained (bool): If True, returns a a-model pre-trained on ImageNet
...
def resnet34(pretrained=False, progress=True, device='cpu', **kwargs):
    """Constructs a ResNet-34 a-model.
...
def resnet50(pretrained=False, progress=True, device='cpu', **kwargs):
    """Constructs a ResNet-50 a-model.
...
def resnet101(pretrained=False, progress=True, **kwargs):
    """Constructs a ResNet-101 a-model.
...
def resnet152(pretrained=False, progress=True, **kwargs):
    """Constructs a ResNet-152 a-model.
...
def resnext50_32x4d(pretrained=False, progress=True, **kwargs):
    """Constructs a ResNeXt-50 32x4d a-model.
...
def resnext101_32x8d(pretrained=False, progress=True, **kwargs):
    """Constructs a ResNeXt-101 32x8d a-model.
